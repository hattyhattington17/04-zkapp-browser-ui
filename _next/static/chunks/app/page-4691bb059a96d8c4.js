...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7192));
...
class ZkappWorkerClient {
    ...
    constructor(){
        this.worker = new Worker(__webpack_require__.tu(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u(115), __webpack_require__.b)));
        this.promises = {};
        this.nextId = 0;
...
/******/ __webpack_require__.O(0, [357,917,971,23,744], function() { return __webpack_exec__(7201); });
